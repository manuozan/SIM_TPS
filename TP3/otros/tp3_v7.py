...
resultado_frame.grid(row=2, column=0, padx=10, pady=10, sticky="we")
...
# Ajustar el campo de texto para expandirse horizontalmente
resultado_text.grid(row=0, column=0, padx=5, pady=5, sticky="nsew")  # Ajustar al ancho de la ventana
